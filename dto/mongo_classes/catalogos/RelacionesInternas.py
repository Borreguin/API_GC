...
class RelacionesInternas(Document):
    ...
    document = StringField(required=True, default="RelacionesInternas")
    meta = {"collection": "CATALOGO|RelacionesInternas"}
    ...
    def __repr__(self):
        return f"<RelacionesInternas {self.codigo},{self.nombre}>"
