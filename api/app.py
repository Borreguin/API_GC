...
from api.services.Catalogos.endpoints.apiCatalogosAsExcel import ns as namespace_catalogos
...
def adding_app_routes(app):
    ...
    def main_page():
        ...
        return f"This is home page for this API, check the prefix to see the UI: {init.API_URL_PREFIX} " \
               f"<br><br>Gerencia Nacional de Desarrollo Técnico - Marzo 2021 - API Gestión de conocimiento - Fase 3 "
